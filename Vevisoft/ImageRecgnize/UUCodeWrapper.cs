...
namespace Vevisoft.ImageRecgnize
{
    public class UUCodeWrapper
    {
        ...
        public static extern void uu_setSoftInfoA(int softId, string softKey);
        ...
        /// </returns>
        [DllImport("UUWiseHelper.dll")]
        public static extern int uu_loginA(string u, string p);
        ...
        /// <returns></returns>
        [DllImport("UUWiseHelper.dll")]
        public static extern int uu_reguserA(string u, string p, int softid, string softkey);
        ...
        /// <returns></returns>
        [DllImport("UUWiseHelper.dll")]
        public static extern int uu_recognizeByCodeTypeAndPathA(string path, int codeType, StringBuilder result);

        [DllImport("UUWiseHelper.dll")]
        public static extern int uu_recognizeScreenByCodeTypeA(int x, int y, int width, int height, int codetype,
